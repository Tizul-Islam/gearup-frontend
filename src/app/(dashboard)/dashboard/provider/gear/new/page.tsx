...
import { useAddGear } from "@/hooks/use-provider";
...
export default function AddGearPage() {
  ...
  const form = useForm<AddGearFormValues>({
    resolver: zodResolver(addGearSchema) as any,
    defaultValues: {
      name: "",
      description: "",
      brand: "",
  ...
  const onSubmit = (data: AddGearFormValues) => {
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <Input 
                  ...
                  placeholder="e.g. Pro Staff Tennis Racket"
                />
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  {...form.register("brand")} 
                  className="rounded-xl" 
                  placeholder="e.g. Wilson, Nike, Coleman"
                />
            ...
            <div className="flex justify-end pt-4 border-t border-border/50">
              ...
              <Button 
                ...
                disabled={addGear.isPending}
              >
                {addGear.isPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                Add Gear
              </Button>
            </div>
          </form>
